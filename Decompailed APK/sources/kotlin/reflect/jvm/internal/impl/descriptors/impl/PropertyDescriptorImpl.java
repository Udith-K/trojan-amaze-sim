...
public class PropertyDescriptorImpl extends VariableDescriptorWithInitializerImpl implements PropertyDescriptor {
    ...
    */
    ...
    protected PropertyDescriptor doSubstitute(CopyConfiguration copyConfiguration) {
        ...
        Iterator it = this.contextReceiverParameters.iterator();
        while (it.hasNext()) {
            ReceiverParameterDescriptor receiverParameterDescriptorSubstituteContextParameterDescriptor = substituteContextParameterDescriptor(typeSubstitutorSubstituteTypeParameters, propertyDescriptorImplCreateSubstitutedCopy, (ReceiverParameterDescriptor) it.next());
        ...
        if (propertySetterDescriptorImpl != null) {
            List substitutedValueParameters = FunctionDescriptorImpl.getSubstitutedValueParameters(propertySetterDescriptorImpl, this.setter.getValueParameters(), typeSubstitutorSubstituteTypeParameters, false, false, null);
        ...
        if (copyConfiguration.copyOverrides) {
            ...
            while (it2.hasNext()) {
                smartSetCreate.add(((PropertyDescriptor) it2.next()).substitute(typeSubstitutorSubstituteTypeParameters));
            }
    ...
    public Collection getOverriddenDescriptors() {
        Collection collectionEmptyList = this.overriddenProperties;
