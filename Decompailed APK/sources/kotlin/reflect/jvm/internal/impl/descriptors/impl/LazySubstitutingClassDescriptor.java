...
public class LazySubstitutingClassDescriptor extends ModuleAwareClassDescriptor {
    ...
    */
    ...
    private TypeSubstitutor getSubstitutor() {
        if (this.newSubstitutor == null) {
            if (this.originalSubstitutor.isEmpty()) {
                ...
                this.declaredTypeParameters = CollectionsKt.filter(this.typeConstructorParameters, new Function1() { // from class: kotlin.reflect.jvm.internal.impl.descriptors.impl.LazySubstitutingClassDescriptor.1
    ...
    public ClassDescriptor mo2746getCompanionObjectDescriptor() {
        return this.original.mo2746getCompanionObjectDescriptor();
    }
    ...
    public ClassConstructorDescriptor mo2747getUnsubstitutedPrimaryConstructor() {
        return this.original.mo2747getUnsubstitutedPrimaryConstructor();
    }
