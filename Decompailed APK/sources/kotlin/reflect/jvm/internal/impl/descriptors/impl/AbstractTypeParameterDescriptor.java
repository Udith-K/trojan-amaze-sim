...
public abstract class AbstractTypeParameterDescriptor extends DeclarationDescriptorNonRootImpl implements TypeParameterDescriptor {
    ...
    protected abstract void mo2784reportSupertypeLoopError(KotlinType kotlinType);
    ...
    public List getUpperBounds() {
        List listMo2782getSupertypes = ((TypeParameterTypeConstructor) getTypeConstructor()).mo2782getSupertypes();
        if (listMo2782getSupertypes == null) {
            $$$reportNull$$$0(8);
        }
        return listMo2782getSupertypes;
    }
    ...
    private class TypeParameterTypeConstructor extends AbstractTypeConstructor {
        ...
        protected Collection computeSupertypes() {
            List listResolveUpperBounds = this.this$0.resolveUpperBounds();
        ...
        protected void reportSupertypeLoopError(KotlinType kotlinType) {
            ...
            this.this$0.mo2784reportSupertypeLoopError(kotlinType);
        }

        @Override // kotlin.reflect.jvm.internal.impl.types.AbstractTypeConstructor
        protected List processSupertypesWithoutCycles(List list) {
            if (list == null) {
                $$$reportNull$$$0(7);
            }
            List listProcessBoundsWithoutCycles = this.this$0.processBoundsWithoutCycles(list);
