...
public abstract class FunctionDescriptorImpl extends DeclarationDescriptorNonRootImpl implements FunctionDescriptor {
    ...
    public Collection getOverriddenDescriptors() {
        ...
        Collection collectionEmptyList = this.overriddenFunctions;
    ...
    public boolean isOperator() {
        ...
        Iterator it = getOriginal().getOverriddenDescriptors().iterator();
        while (it.hasNext()) {
    ...
    protected FunctionDescriptor doSubstitute(CopyConfiguration copyConfiguration) {
        ...
        List substitutedValueParameters = getSubstitutedValueParameters(functionDescriptorImplCreateSubstitutedCopy, copyConfiguration.newValueParameterDescriptors, typeSubstitutorSubstituteTypeParameters, copyConfiguration.dropOriginalInContainingParts, copyConfiguration.preserveSourceElement, zArr);
            ...
            if (copyConfiguration.substitution.isEmpty()) {
                ...
                functionDescriptorImplCreateSubstitutedCopy.lazyOverriddenFunctionsTask = new Function0() { // from class: kotlin.reflect.jvm.internal.impl.descriptors.impl.FunctionDescriptorImpl.1
                    ...
                    public Collection invoke() {
                        ...
                        Iterator it = FunctionDescriptorImpl.this.getOverriddenDescriptors().iterator();
                        while (it.hasNext()) {
                            smartList.add(((FunctionDescriptor) it.next()).substitute(typeSubstitutorSubstituteTypeParameters));
                        }
                        return smartList;
                    }
                };
