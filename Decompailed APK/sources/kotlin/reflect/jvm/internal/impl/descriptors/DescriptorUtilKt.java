...
public abstract class DescriptorUtilKt {
    public static final ClassDescriptor resolveClassByFqName(ModuleDescriptor moduleDescriptor, FqName fqName, LookupLocation lookupLocation) {
        ...
        ClassifierDescriptor classifierDescriptorMo2783getContributedClassifier2 = memberScope.mo2783getContributedClassifier(nameShortName, lookupLocation);
        ClassDescriptor classDescriptor = classifierDescriptorMo2783getContributedClassifier2 instanceof ClassDescriptor ? (ClassDescriptor) classifierDescriptorMo2783getContributedClassifier2 : null;
        ...
        if (classDescriptorResolveClassByFqName == null || (unsubstitutedInnerClassesScope = classDescriptorResolveClassByFqName.getUnsubstitutedInnerClassesScope()) == null) {
            classifierDescriptorMo2783getContributedClassifier = null;
        } else {
            Name nameShortName2 = fqName.shortName();
            Intrinsics.checkNotNullExpressionValue(nameShortName2, "shortName(...)");
            classifierDescriptorMo2783getContributedClassifier = unsubstitutedInnerClassesScope.mo2783getContributedClassifier(nameShortName2, lookupLocation);
        }
