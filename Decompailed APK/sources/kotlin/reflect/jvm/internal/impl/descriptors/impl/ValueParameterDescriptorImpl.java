...
public class ValueParameterDescriptorImpl extends VariableDescriptorImpl implements ValueParameterDescriptor {
    ...
    public /* bridge */ /* synthetic */ ConstantValue mo2749getCompileTimeInitializer() {
    ...
    public Collection getOverriddenDescriptors() {
        ...
        while (it.hasNext()) {
            arrayList.add((ValueParameterDescriptor) ((CallableDescriptor) it.next()).getValueParameters().get(getIndex()));
        }
        return arrayList;
    }
}
