...
public abstract class Flags {
    ...
    */
    ...
    static {
        ...
        FlagField flagFieldAfter = FlagField.after(booleanFlagFieldBooleanFirst2, ProtoBuf$Visibility.values());
        VISIBILITY = flagFieldAfter;
        FlagField flagFieldAfter2 = FlagField.after(flagFieldAfter, ProtoBuf$Modality.values());
        MODALITY = flagFieldAfter2;
        FlagField flagFieldAfter3 = FlagField.after(flagFieldAfter2, ProtoBuf$Class.Kind.values());
        ...
        FlagField flagFieldAfter4 = FlagField.after(flagFieldAfter2, ProtoBuf$MemberKind.values());
