    ...
    public static final class StringTableTypes extends GeneratedMessageLite implements MessageLiteOrBuilder {
        ...
        public static final class Record extends GeneratedMessageLite implements MessageLiteOrBuilder {
            ...
            public int getSerializedSize() {
                ...
                for (int i2 = 0; i2 < this.substringIndex_.size(); i2++) {
                    iComputeInt32SizeNoTag += CodedOutputStream.computeInt32SizeNoTag(((Integer) this.substringIndex_.get(i2)).intValue());
                }
                ...
                for (int i3 = 0; i3 < this.replaceChar_.size(); i3++) {
                    iComputeInt32SizeNoTag3 += CodedOutputStream.computeInt32SizeNoTag(((Integer) this.replaceChar_.get(i3)).intValue());
                }
        ...
        public int getSerializedSize() {
            ...
            for (int i2 = 0; i2 < this.record_.size(); i2++) {
                iComputeMessageSize += CodedOutputStream.computeMessageSize(1, (MessageLite) this.record_.get(i2));
            }
            int iComputeInt32SizeNoTag = 0;
            for (int i3 = 0; i3 < this.localName_.size(); i3++) {
                iComputeInt32SizeNoTag += CodedOutputStream.computeInt32SizeNoTag(((Integer) this.localName_.get(i3)).intValue());
            }
