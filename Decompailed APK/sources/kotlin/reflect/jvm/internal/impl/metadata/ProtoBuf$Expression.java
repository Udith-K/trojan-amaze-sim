...
public final class ProtoBuf$Expression extends GeneratedMessageLite implements MessageLiteOrBuilder {
    ...
    public int getSerializedSize() {
        ...
        for (int i2 = 0; i2 < this.andArgument_.size(); i2++) {
            iComputeInt32Size += CodedOutputStream.computeMessageSize(6, (MessageLite) this.andArgument_.get(i2));
        }
        for (int i3 = 0; i3 < this.orArgument_.size(); i3++) {
            iComputeInt32Size += CodedOutputStream.computeMessageSize(7, (MessageLite) this.orArgument_.get(i3));
        }
