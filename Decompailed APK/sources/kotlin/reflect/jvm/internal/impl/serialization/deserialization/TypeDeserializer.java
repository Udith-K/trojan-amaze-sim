...
public final class TypeDeserializer {
    ...
    public final KotlinType type(ProtoBuf$Type proto) {
        ...
        if (proto.hasFlexibleTypeCapabilitiesId()) {
            ...
            ProtoBuf$Type protoBuf$TypeFlexibleUpperBound = ProtoTypeTableUtilKt.flexibleUpperBound(proto, this.c.getTypeTable());
            Intrinsics.checkNotNull(protoBuf$TypeFlexibleUpperBound);
            return this.c.getComponents().getFlexibleTypeDeserializer().create(proto, string, simpleTypeSimpleType$default, simpleType$default(this, protoBuf$TypeFlexibleUpperBound, false, 2, null));
        }
    ...
    public final SimpleType simpleType(final ProtoBuf$Type proto, boolean z) {
        ...
        if (ErrorUtils.isError(typeConstructor.mo2781getDeclarationDescriptor())) {
        ...
        if (z && (classifierDescriptorMo2781getDeclarationDescriptor instanceof TypeAliasDescriptor)) {
            SimpleType simpleTypeComputeExpandedType = KotlinTypeFactory.computeExpandedType((TypeAliasDescriptor) classifierDescriptorMo2781getDeclarationDescriptor, list);
            ...
            simpleTypeSimpleType$default = KotlinTypeFactory.simpleType$default(attributes, typeConstructor, list, proto.getNullable(), null, 16, null);
        ...
        ProtoBuf$Type protoBuf$TypeAbbreviatedType = ProtoTypeTableUtilKt.abbreviatedType(proto, this.c.getTypeTable());
        return (protoBuf$TypeAbbreviatedType == null || (simpleTypeWithAbbreviation = SpecialTypesKt.withAbbreviation(simpleTypeSimpleType$default, simpleType(protoBuf$TypeAbbreviatedType, false))) == null) ? simpleTypeSimpleType$default : simpleTypeWithAbbreviation;
    }
    ...
    private static final List simpleType$collectAllArguments(ProtoBuf$Type protoBuf$Type, TypeDeserializer typeDeserializer) {
        ...
        List listSimpleType$collectAllArguments = protoBuf$TypeOuterType != null ? simpleType$collectAllArguments(protoBuf$TypeOuterType, typeDeserializer) : null;
    ...
    private static final ClassDescriptor typeConstructor$notFoundClass(final TypeDeserializer typeDeserializer, ProtoBuf$Type protoBuf$Type, int i) {
        ...
        List mutableList = SequencesKt.toMutableList(SequencesKt.map(SequencesKt.generateSequence(protoBuf$Type, new Function1(typeDeserializer) { // from class: kotlin.reflect.jvm.internal.impl.serialization.deserialization.TypeDeserializer$$Lambda$3
            private final TypeDeserializer arg$0;
    ...
    private final TypeConstructor typeConstructor(ProtoBuf$Type protoBuf$Type) {
        ...
        if (protoBuf$Type.hasClassName()) {
            classifierDescriptorTypeConstructor$notFoundClass = (ClassifierDescriptor) this.classifierDescriptors.invoke(Integer.valueOf(protoBuf$Type.getClassName()));
            if (classifierDescriptorTypeConstructor$notFoundClass == null) {
                classifierDescriptorTypeConstructor$notFoundClass = typeConstructor$notFoundClass(this, protoBuf$Type, protoBuf$Type.getClassName());
            }
        } else if (protoBuf$Type.hasTypeParameter()) {
            classifierDescriptorTypeConstructor$notFoundClass = loadTypeParameter(protoBuf$Type.getTypeParameter());
            if (classifierDescriptorTypeConstructor$notFoundClass == null) {
            ...
            classifierDescriptorTypeConstructor$notFoundClass = (ClassifierDescriptor) this.typeAliasDescriptors.invoke(Integer.valueOf(protoBuf$Type.getTypeAliasName()));
            if (classifierDescriptorTypeConstructor$notFoundClass == null) {
                classifierDescriptorTypeConstructor$notFoundClass = typeConstructor$notFoundClass(this, protoBuf$Type, protoBuf$Type.getTypeAliasName());
            }
        } else {
    ...
    private final SimpleType createSuspendFunctionType(TypeAttributes typeAttributes, TypeConstructor typeConstructor, List list, boolean z) {
        ...
        if (size2 != 0) {
            ...
            if (size2 == 1 && (size = list.size() - 1) >= 0) {
                ...
                simpleTypeCreateSuspendFunctionTypeForBasicCase = KotlinTypeFactory.simpleType$default(typeAttributes, typeConstructor2, list, z, null, 16, null);
            }
        } else {
    ...
    private final SimpleType createSuspendFunctionTypeForBasicCase(TypeAttributes typeAttributes, TypeConstructor typeConstructor, List list, boolean z) {
        SimpleType simpleTypeSimpleType$default = KotlinTypeFactory.simpleType$default(typeAttributes, typeConstructor, list, z, null, 16, null);
    ...
    private final SimpleType transformRuntimeFunctionTypeToSuspendFunction(KotlinType kotlinType) {
        ...
        FqName fqNameSafe = classifierDescriptorMo2781getDeclarationDescriptor != null ? DescriptorUtilsKt.getFqNameSafe(classifierDescriptorMo2781getDeclarationDescriptor) : null;
    ...
    private final TypeProjection typeArgument(TypeParameterDescriptor typeParameterDescriptor, ProtoBuf$Type.Argument argument) {
        ...
        return new TypeProjectionImpl(variance, type(protoBuf$TypeType));
    }
