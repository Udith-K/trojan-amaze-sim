...
public final class DeserializedTypeParameterDescriptor extends AbstractLazyTypeParameterDescriptor {
    ...
    protected List resolveUpperBounds() {
        List listUpperBounds = ProtoTypeTableUtilKt.upperBounds(this.proto, this.c.getTypeTable());
        ...
        Iterator it = listUpperBounds.iterator();
        while (it.hasNext()) {
    ...
    public Void mo2784reportSupertypeLoopError(KotlinType type) {
