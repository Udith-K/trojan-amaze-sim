...
public abstract class JvmAnnotationNamesKt {
    private static final Set BUILT_IN_TYPE_QUALIFIER_ANNOTATIONS;
    private static final Set FORCE_FLEXIBILITY_ANNOTATIONS;
    ...
    private static final Set NOT_NULL_ANNOTATIONS;
    private static final Set NULLABILITY_ANNOTATIONS;
    private static final Set NULLABLE_ANNOTATIONS;
    ...
    static {
        ...
        NULLABILITY_ANNOTATIONS = SetsKt.plus(SetsKt.plus(SetsKt.plus(SetsKt.plus(SetsKt.plus(SetsKt.plus((Set) new LinkedHashSet(), (Iterable) of), (Iterable) of2), fqName9), fqName2), fqName6), fqName8);
    ...
    public static final Set getBUILT_IN_TYPE_QUALIFIER_ANNOTATIONS() {
        return BUILT_IN_TYPE_QUALIFIER_ANNOTATIONS;
    }

    public static final Set getNOT_NULL_ANNOTATIONS() {
        return NOT_NULL_ANNOTATIONS;
    }

    public static final Set getNULLABLE_ANNOTATIONS() {
        return NULLABLE_ANNOTATIONS;
    }

    public static final Set getFORCE_FLEXIBILITY_ANNOTATIONS() {
