...
public final class LazyJavaClassDescriptor extends ClassDescriptorBase implements JavaClassDescriptor {
    ...
    private static final Set PUBLIC_METHOD_NAMES_IN_OBJECT = SetsKt.setOf((Object[]) new String[]{"equals", "hashCode", "getClass", "wait", "notify", "notifyAll", "toString"});
    ...
    public Collection getSealedSubclasses() {
        if (this.modality == Modality.SEALED) {
            ...
            Sequence permittedTypes = this.jClass.getPermittedTypes();
            ArrayList arrayList = new ArrayList();
            Iterator it = permittedTypes.iterator();
            while (it.hasNext()) {
                ClassifierDescriptor classifierDescriptorMo2781getDeclarationDescriptor = this.c.getTypeResolver().transformJavaType((JavaClassifierType) it.next(), attributes$default).getConstructor().mo2781getDeclarationDescriptor();
    ...
    final class LazyJavaClassTypeConstructor extends AbstractClassTypeConstructor {
        ...
        protected Collection computeSupertypes() {
            ...
            while (true) {
                ...
                KotlinType kotlinTypeEnhanceSuperType = LazyJavaClassDescriptor.this.c.getComponents().getSignatureEnhancement().enhanceSuperType(LazyJavaClassDescriptor.this.c.getTypeResolver().transformJavaType(javaClassifierType, JavaTypeAttributesKt.toAttributes$default(TypeUsage.SUPERTYPE, false, false, null, 7, null)), LazyJavaClassDescriptor.this.c);
                if (kotlinTypeEnhanceSuperType.getConstructor().mo2781getDeclarationDescriptor() instanceof NotFoundClasses.MockClassDescriptor) {
            ...
            if (!arrayList2.isEmpty()) {
                ...
                ClassDescriptor classDescriptorMo2781getDeclarationDescriptor = mo2781getDeclarationDescriptor();
                ...
                errorReporter.reportIncompleteHierarchy(classDescriptorMo2781getDeclarationDescriptor, arrayList3);
            }
        ...
        private final KotlinType getPurelyImplementedSupertype() {
            ...
            if (size2 == size) {
                ...
                TypeProjectionImpl typeProjectionImpl = new TypeProjectionImpl(Variance.INVARIANT, ((TypeParameterDescriptor) CollectionsKt.single(parameters)).getDefaultType());
        ...
        private final FqName getPurelyImplementsFqNameFromAnnotation() {
            ...
            AnnotationDescriptor annotationDescriptorMo2748findAnnotation = annotations.mo2748findAnnotation(PURELY_IMPLEMENTS_ANNOTATION);
            if (annotationDescriptorMo2748findAnnotation == null) {
                return null;
            }
            Object objSingleOrNull = CollectionsKt.singleOrNull(annotationDescriptorMo2748findAnnotation.getAllValueArguments().values());
        ...
        public ClassDescriptor mo2781getDeclarationDescriptor() {
