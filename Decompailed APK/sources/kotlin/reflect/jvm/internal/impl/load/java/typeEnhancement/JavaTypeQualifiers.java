...
public final class JavaTypeQualifiers {
    ...
    public int hashCode() {
        ...
        return ((((iHashCode + (mutabilityQualifier != null ? mutabilityQualifier.hashCode() : 0)) * 31) + ChangeSize$$ExternalSyntheticBackport0.m(this.definitelyNotNull)) * 31) + ChangeSize$$ExternalSyntheticBackport0.m(this.isNullabilityQualifierForWarning);
    }

    public String toString() {
        return "JavaTypeQualifiers(nullability=" + this.nullability + ", mutability=" + this.mutability + ", definitelyNotNull=" + this.definitelyNotNull + ", isNullabilityQualifierForWarning=" + this.isNullabilityQualifierForWarning + CoreConstants.RIGHT_PARENTHESIS_CHAR;
    }
