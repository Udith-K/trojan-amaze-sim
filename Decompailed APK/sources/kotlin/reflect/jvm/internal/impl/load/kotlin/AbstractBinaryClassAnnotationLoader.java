...
public abstract class AbstractBinaryClassAnnotationLoader implements AnnotationLoader {
    ...
    protected final KotlinJvmBinaryClass.AnnotationArgumentVisitor loadAnnotationIfNotSpecial(ClassId annotationClassId, SourceElement source, List result) {
    ...
    private final List findClassAndLoadMemberAnnotations(ProtoContainer protoContainer, MemberSignature memberSignature, boolean z, boolean z2, Boolean bool, boolean z3) {
        ...
        List list = (List) getAnnotationsContainer(kotlinJvmBinaryClassFindClassWithAnnotationsAndInitializers).getMemberAnnotations().get(memberSignature);
            ...
            if (z) {
                ...
                if (bool.booleanValue() && (container instanceof ProtoContainer.Package)) {
                    ...
                    if (facadeClassName != null) {
                        ...
                        return KotlinClassFinderKt.findKotlinClass(kotlinClassFinder, companion.topLevel(new FqName(StringsKt.replace$default(internalName, '/', CoreConstants.DOT, false, 4, (Object) null))), jvmMetadataVersion);
                    }
                }
            }
