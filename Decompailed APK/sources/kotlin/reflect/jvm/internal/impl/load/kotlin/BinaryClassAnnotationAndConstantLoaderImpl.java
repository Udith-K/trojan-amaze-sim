...
public final class BinaryClassAnnotationAndConstantLoaderImpl extends AbstractBinaryClassAnnotationAndConstantLoader {
    ...
    @Override // kotlin.reflect.jvm.internal.impl.load.kotlin.AbstractBinaryClassAnnotationLoader
    protected KotlinJvmBinaryClass.AnnotationArgumentVisitor loadAnnotation(final ClassId annotationClassId, final SourceElement source, final List result) {
        ...
        return new AbstractAnnotationArgumentVisitor() { // from class: kotlin.reflect.jvm.internal.impl.load.kotlin.BinaryClassAnnotationAndConstantLoaderImpl.loadAnnotation.1
            ...
            public void visitArrayValue(Name name, ArrayList elements) {
                ...
                if (annotationParameterByName != null) {
                    HashMap map = this.arguments;
                    ConstantValueFactory constantValueFactory = ConstantValueFactory.INSTANCE;
                    List listCompact = CollectionsKt.compact(elements);
                ...
                if (BinaryClassAnnotationAndConstantLoaderImpl.this.isImplicitRepeatableContainer(annotationClassId) && Intrinsics.areEqual(name.asString(), Action.VALUE_ATTRIBUTE)) {
                    ...
                    while (it.hasNext()) {
                        list.add((AnnotationDescriptor) ((AnnotationValue) it.next()).getValue());
                    }
                }
            }
