        ...
        while (!supertypesDeque.isEmpty()) {
            ...
            if (supertypesSet.add(simpleTypeMarker)) {
                ...
                if (supertypesPolicy2 == null) {
                    ...
                    while (it.hasNext()) {
                        SimpleTypeMarker simpleTypeMarkerMo2785transformType = supertypesPolicy2.mo2785transformType(typeCheckerState, (KotlinTypeMarker) it.next());
                        if ((typeSystemContext.isClassType(simpleTypeMarkerMo2785transformType) && !typeSystemContext.isMarkedNullable(simpleTypeMarkerMo2785transformType)) || typeSystemContext.isDefinitelyNotNullType(simpleTypeMarkerMo2785transformType)) {
        ...
        while (!supertypesDeque.isEmpty()) {
            ...
            if (supertypesSet.add(simpleTypeMarker)) {
                ...
                if (supertypesPolicy == null) {
                    ...
                    Iterator it = typeSystemContext2.supertypes(typeSystemContext2.typeConstructor(simpleTypeMarker)).iterator();
                    while (it.hasNext()) {
                        SimpleTypeMarker simpleTypeMarkerMo2785transformType = supertypesPolicy.mo2785transformType(state, (KotlinTypeMarker) it.next());
                        if (INSTANCE.isApplicableAsEndNode(state, simpleTypeMarkerMo2785transformType, end)) {
                            state.clear();
                            return true;
                        }
                        supertypesDeque.add(simpleTypeMarkerMo2785transformType);
