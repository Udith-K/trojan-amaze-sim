...
public final class ErrorPropertyDescriptor implements PropertyDescriptor {
    ...
    public List getAccessors() {
        List accessors = this.$$delegate_0.getAccessors();
    ...
    public ConstantValue mo2749getCompileTimeInitializer() {
        return this.$$delegate_0.mo2749getCompileTimeInitializer();
    }
    ...
    public List getContextReceiverParameters() {
        List contextReceiverParameters = this.$$delegate_0.getContextReceiverParameters();
    ...
    public Collection getOverriddenDescriptors() {
        Collection overriddenDescriptors = this.$$delegate_0.getOverriddenDescriptors();
    ...
    public List getTypeParameters() {
        List typeParameters = this.$$delegate_0.getTypeParameters();
    ...
    public List getValueParameters() {
        List valueParameters = this.$$delegate_0.getValueParameters();
