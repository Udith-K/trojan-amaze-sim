...
public abstract class ClassifierBasedTypeConstructor implements TypeConstructor {
    ...
    public abstract ClassifierDescriptor mo2781getDeclarationDescriptor();
    ...
    public int hashCode() {
        ...
        ClassifierDescriptor classifierDescriptorMo2781getDeclarationDescriptor = mo2781getDeclarationDescriptor();
        if (hasMeaningfulFqName(classifierDescriptorMo2781getDeclarationDescriptor)) {
            iIdentityHashCode = DescriptorUtils.getFqName(classifierDescriptorMo2781getDeclarationDescriptor).hashCode();
        } else {
    ...
    public boolean equals(Object obj) {
        ...
        ClassifierDescriptor classifierDescriptorMo2781getDeclarationDescriptor = mo2781getDeclarationDescriptor();
        ClassifierDescriptor classifierDescriptorMo2781getDeclarationDescriptor2 = typeConstructor.mo2781getDeclarationDescriptor();
        if (classifierDescriptorMo2781getDeclarationDescriptor2 != null && hasMeaningfulFqName(classifierDescriptorMo2781getDeclarationDescriptor) && hasMeaningfulFqName(classifierDescriptorMo2781getDeclarationDescriptor2)) {
            return isSameClassifier(classifierDescriptorMo2781getDeclarationDescriptor2);
        }
        return false;
    }
