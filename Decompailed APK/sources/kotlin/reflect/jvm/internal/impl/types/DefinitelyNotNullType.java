...
public final class DefinitelyNotNullType extends DelegatingSimpleType implements CustomTypeParameter, DefinitelyNotNullTypeMarker {
    ...
    public static final class Companion {
        ...
        private final boolean makesSenseToBeDefinitelyNotNull(UnwrappedType unwrappedType, boolean z) {
            ...
            TypeParameterDescriptorImpl typeParameterDescriptorImpl = classifierDescriptorMo2781getDeclarationDescriptor instanceof TypeParameterDescriptorImpl ? (TypeParameterDescriptorImpl) classifierDescriptorMo2781getDeclarationDescriptor : null;
            if (typeParameterDescriptorImpl != null && !typeParameterDescriptorImpl.isInitialized()) {
                return true;
            }
            if (z && (unwrappedType.getConstructor().mo2781getDeclarationDescriptor() instanceof TypeParameterDescriptor)) {
        ...
        private final boolean canHaveUndefinedNullability(UnwrappedType unwrappedType) {
            ...
            return (unwrappedType.getConstructor().mo2781getDeclarationDescriptor() instanceof TypeParameterDescriptor) || (unwrappedType instanceof NewCapturedType);
        }
    }
    ...
    public boolean isTypeParameter() {
        ...
        return getDelegate().getConstructor().mo2781getDeclarationDescriptor() instanceof TypeParameterDescriptor;
    }
