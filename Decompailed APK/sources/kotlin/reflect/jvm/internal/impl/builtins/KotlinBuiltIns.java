...
public abstract class KotlinBuiltIns {
    ...
    protected KotlinBuiltIns(StorageManager storageManager) {
        ...
        this.builtInClassesByName = storageManager.createMemoizedFunction(new Function1() { // from class: kotlin.reflect.jvm.internal.impl.builtins.KotlinBuiltIns.3
            ...
            public ClassDescriptor invoke(Name name) {
                ClassifierDescriptor classifierDescriptorMo2783getContributedClassifier = KotlinBuiltIns.this.getBuiltInsPackageScope().mo2783getContributedClassifier(name, NoLookupLocation.FROM_BUILTINS);
                ...
                if (!(classifierDescriptorMo2783getContributedClassifier instanceof ClassDescriptor)) {
                    throw new AssertionError("Must be a class descriptor " + name + ", but was " + classifierDescriptorMo2783getContributedClassifier);
                }
    ...
    public static boolean isPrimitiveArray(KotlinType kotlinType) {
        ...
        ClassifierDescriptor classifierDescriptorMo2781getDeclarationDescriptor = kotlinType.getConstructor().mo2781getDeclarationDescriptor();
        return (classifierDescriptorMo2781getDeclarationDescriptor == null || getPrimitiveArrayType(classifierDescriptorMo2781getDeclarationDescriptor) == null) ? false : true;
    }
    ...
    public static PrimitiveType getPrimitiveArrayElementType(KotlinType kotlinType) {
        ...
        return getPrimitiveArrayType(classifierDescriptorMo2781getDeclarationDescriptor);
    }
    ...
    public static boolean isPrimitiveTypeOrNullablePrimitiveType(KotlinType kotlinType) {
        ...
        ClassifierDescriptor classifierDescriptorMo2781getDeclarationDescriptor = kotlinType.getConstructor().mo2781getDeclarationDescriptor();
        return (classifierDescriptorMo2781getDeclarationDescriptor instanceof ClassDescriptor) && isPrimitiveClass((ClassDescriptor) classifierDescriptorMo2781getDeclarationDescriptor);
    }
    ...
    public static boolean isTypeConstructorForGivenClass(TypeConstructor typeConstructor, FqNameUnsafe fqNameUnsafe) {
        ...
        return (classifierDescriptorMo2781getDeclarationDescriptor instanceof ClassDescriptor) && classFqNameEquals(classifierDescriptorMo2781getDeclarationDescriptor, fqNameUnsafe);
    }
