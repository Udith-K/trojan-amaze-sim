...
public final class ReflectionTypes {
    ...
    public final ClassDescriptor find(String str, int i) {
        ...
        ClassifierDescriptor classifierDescriptorMo2783getContributedClassifier = getKotlinReflectScope().mo2783getContributedClassifier(nameIdentifier, NoLookupLocation.FROM_REFLECTION);
    ...
    public static final class Companion {
        ...
        public final KotlinType createKPropertyStarType(ModuleDescriptor module) {
            ...
            List parameters = classDescriptorFindClassAcrossModuleDependencies.getTypeConstructor().getParameters();
            Intrinsics.checkNotNullExpressionValue(parameters, "getParameters(...)");
            Object objSingle = CollectionsKt.single(parameters);
