...
public final class FunctionInvokeDescriptor extends SimpleFunctionDescriptorImpl {
    ...
    private final FunctionDescriptor replaceParameterNames(List list) {
        ...
        FunctionDescriptorImpl.CopyConfiguration original = copyConfigurationNewCopyBuilder.setHasSynthesizedParameterNames(z).setValueParameters((List) arrayList).setOriginal((CallableMemberDescriptor) getOriginal());
    ...
    public static final class Factory {
        ...
        public final FunctionInvokeDescriptor create(FunctionClassDescriptor functionClass, boolean z) {
            ...
            functionInvokeDescriptor.initialize((ReceiverParameterDescriptor) null, thisAsReceiverParameter, listEmptyList, listEmptyList2, (List) arrayList2, (KotlinType) ((TypeParameterDescriptor) CollectionsKt.last(declaredTypeParameters)).getDefaultType(), Modality.ABSTRACT, DescriptorVisibilities.PUBLIC);
