...
class RopeByteString extends ByteString {
    ...
    private boolean equalsFragments(ByteString byteString) {
        ...
        while (true) {
            ...
            if (!(i == 0 ? literalByteString.equalsRange(literalByteString2, i2, iMin) : literalByteString2.equalsRange(literalByteString, i, iMin))) {
                return false;
            }
            i3 += iMin;
    ...
    private static class Balancer {
        ...
        private void insert(ByteString byteString) {
            ...
            if (!this.prefixesStack.isEmpty() && ((ByteString) this.prefixesStack.peek()).size() < i) {
                ...
                ByteString ropeByteString = (ByteString) this.prefixesStack.pop();
                while (true) {
                    if (this.prefixesStack.isEmpty() || ((ByteString) this.prefixesStack.peek()).size() >= i2) {
                        break;
                    } else {
                        ropeByteString = new RopeByteString((ByteString) this.prefixesStack.pop(), ropeByteString);
                    }
                ...
                while (!this.prefixesStack.isEmpty()) {
                    if (((ByteString) this.prefixesStack.peek()).size() >= RopeByteString.minLengthByDepth[getDepthBinForLength(ropeByteString2.size()) + 1]) {
                        break;
                    } else {
