...
public final class DescriptorEquivalenceForOverrides {
    ...
    public static final boolean areCallableDescriptorsEquivalent$lambda$3(boolean z, final CallableDescriptor callableDescriptor, final CallableDescriptor callableDescriptor2, TypeConstructor c1, TypeConstructor c2) {
        ...
        ClassifierDescriptor classifierDescriptorMo2781getDeclarationDescriptor = c1.mo2781getDeclarationDescriptor();
        ClassifierDescriptor classifierDescriptorMo2781getDeclarationDescriptor2 = c2.mo2781getDeclarationDescriptor();
        if ((classifierDescriptorMo2781getDeclarationDescriptor instanceof TypeParameterDescriptor) && (classifierDescriptorMo2781getDeclarationDescriptor2 instanceof TypeParameterDescriptor)) {
            return INSTANCE.areTypeParametersEquivalent((TypeParameterDescriptor) classifierDescriptorMo2781getDeclarationDescriptor, (TypeParameterDescriptor) classifierDescriptorMo2781getDeclarationDescriptor2, z, new Function2(callableDescriptor, callableDescriptor2) { // from class: kotlin.reflect.jvm.internal.impl.resolve.DescriptorEquivalenceForOverrides$$Lambda$3
