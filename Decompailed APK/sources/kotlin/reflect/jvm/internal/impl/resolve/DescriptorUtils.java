...
public abstract class DescriptorUtils {
    ...
    public static ModuleDescriptor getContainingModuleOrNull(KotlinType kotlinType) {
        ...
        return getContainingModuleOrNull(classifierDescriptorMo2781getDeclarationDescriptor);
    }
    ...
    public static boolean isDirectSubclass(ClassDescriptor classDescriptor, ClassDescriptor classDescriptor2) {
        ...
        Iterator it = classDescriptor.getTypeConstructor().mo2782getSupertypes().iterator();
        while (it.hasNext()) {
            if (isSameClass((KotlinType) it.next(), classDescriptor2.getOriginal())) {
                return true;
            }
        }
        return false;
    ...
    private static boolean isSameClass(KotlinType kotlinType, DeclarationDescriptor declarationDescriptor) {
        ...
        DeclarationDescriptor original = classifierDescriptorMo2781getDeclarationDescriptor.getOriginal();
    ...
    public static boolean isSubtypeOfClass(KotlinType kotlinType, DeclarationDescriptor declarationDescriptor) {
        ...
        Iterator it = kotlinType.getConstructor().mo2782getSupertypes().iterator();
        while (it.hasNext()) {
            if (isSubtypeOfClass((KotlinType) it.next(), declarationDescriptor)) {
                return true;
            }
        }
        return false;
    ...
    public static ClassDescriptor getSuperClassDescriptor(ClassDescriptor classDescriptor) {
        ...
        Iterator it = classDescriptor.getTypeConstructor().mo2782getSupertypes().iterator();
        while (it.hasNext()) {
            ClassDescriptor classDescriptorForType = getClassDescriptorForType((KotlinType) it.next());
    ...
    public static ClassDescriptor getClassDescriptorForTypeConstructor(TypeConstructor typeConstructor) {
        ...
        ClassDescriptor classDescriptor = (ClassDescriptor) typeConstructor.mo2781getDeclarationDescriptor();
        if (classDescriptor == null) {
            $$$reportNull$$$0(47);
        }
    ...
    private static void collectAllOverriddenDescriptors(CallableDescriptor callableDescriptor, Set set) {
        ...
        Iterator it = callableDescriptor.getOriginal().getOverriddenDescriptors().iterator();
        while (it.hasNext()) {
