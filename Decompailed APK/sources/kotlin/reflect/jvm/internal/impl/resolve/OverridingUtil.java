...
public class OverridingUtil {
    ...
    private static final List EXTERNAL_CONDITIONS = CollectionsKt.toList(ServiceLoader.load(ExternalOverridabilityCondition.class, ExternalOverridabilityCondition.class.getClassLoader()));
    ...
    */
    ...
    public static boolean overrides(CallableDescriptor callableDescriptor, CallableDescriptor callableDescriptor2, boolean z, boolean z2) {
        ...
        Iterator it = DescriptorUtils.getAllOverriddenDescriptors(callableDescriptor).iterator();
        while (it.hasNext()) {
    ...
    private static void collectOverriddenDeclarations(CallableMemberDescriptor callableMemberDescriptor, Set set) {
        ...
        while (it.hasNext()) {
            collectOverriddenDeclarations((CallableMemberDescriptor) it.next(), set);
        }
    }
    ...
    public OverrideCompatibilityInfo isOverridableByWithoutExternalConditions(CallableDescriptor callableDescriptor, CallableDescriptor callableDescriptor2, boolean z) {
        ...
        List listCompiledValueParameters = compiledValueParameters(callableDescriptor);
        List listCompiledValueParameters2 = compiledValueParameters(callableDescriptor2);
        ...
        if (typeParameters.size() != typeParameters2.size()) {
            while (i < listCompiledValueParameters.size()) {
                if (!KotlinTypeChecker.DEFAULT.equalTypes((KotlinType) listCompiledValueParameters.get(i), (KotlinType) listCompiledValueParameters2.get(i))) {
        ...
        for (int i2 = 0; i2 < typeParameters.size(); i2++) {
            if (!areTypeParametersEquivalent((TypeParameterDescriptor) typeParameters.get(i2), (TypeParameterDescriptor) typeParameters2.get(i2), typeCheckerStateCreateTypeCheckerState)) {
        ...
        while (i < listCompiledValueParameters.size()) {
            if (!areTypesEquivalent((KotlinType) listCompiledValueParameters.get(i), (KotlinType) listCompiledValueParameters2.get(i), typeCheckerStateCreateTypeCheckerState)) {
    ...
    */
    ...
    private static boolean allHasSameContainingDeclaration(Collection collection) {
        ...
        return CollectionsKt.all(collection, new Function1() { // from class: kotlin.reflect.jvm.internal.impl.resolve.OverridingUtil.3
    ...
    public static Object selectMostSpecificMember(Collection collection, Function1 function1) {
        ...
        Object objFirst2 = CollectionsKt.first(collection);
        CallableDescriptor callableDescriptor = (CallableDescriptor) function1.invoke(objFirst2);
        ...
        if (arrayList.size() == 1) {
            Object objFirst3 = CollectionsKt.first((Iterable) arrayList);
            if (objFirst3 == null) {
                $$$reportNull$$$0(80);
            }
            return objFirst3;
        ...
        Object objFirst4 = CollectionsKt.first((Iterable) arrayList);
        if (objFirst4 == null) {
            $$$reportNull$$$0(82);
        }
        return objFirst4;
    ...
    private static void createAndBindFakeOverride(Collection collection, ClassDescriptor classDescriptor, OverridingStrategy overridingStrategy) {
        ...
        Collection collectionFilterVisibleFakeOverrides = filterVisibleFakeOverrides(classDescriptor, collection);
        boolean zIsEmpty = collectionFilterVisibleFakeOverrides.isEmpty();
        if (!zIsEmpty) {
            collection = collectionFilterVisibleFakeOverrides;
        }
        CallableMemberDescriptor callableMemberDescriptorCopy = ((CallableMemberDescriptor) selectMostSpecificMember(collection, new Function1() { // from class: kotlin.reflect.jvm.internal.impl.resolve.OverridingUtil.4
            @Override // kotlin.jvm.functions.Function1
    ...
    public static Collection filterVisibleFakeOverrides(final ClassDescriptor classDescriptor, Collection collection) {
        ...
        List listFilter = CollectionsKt.filter(collection, new Function1() { // from class: kotlin.reflect.jvm.internal.impl.resolve.OverridingUtil.5
            @Override // kotlin.jvm.functions.Function1
            public Boolean invoke(CallableMemberDescriptor callableMemberDescriptor) {
                boolean z = false;
    ...
    public static void resolveUnknownVisibilityForMember(CallableMemberDescriptor callableMemberDescriptor, Function1 function1) {
        ...
        if (callableMemberDescriptor instanceof PropertyDescriptorImpl) {
            ...
            Iterator it = ((PropertyDescriptor) callableMemberDescriptor).getAccessors().iterator();
            while (it.hasNext()) {
                resolveUnknownVisibilityForMember((PropertyAccessorDescriptor) it.next(), descriptorVisibilityComputeVisibilityToInherit == null ? null : function1);
            }
            return;
        }
    ...
    public static DescriptorVisibility findMaxVisibility(Collection collection) {
        DescriptorVisibility descriptorVisibility;
        if (collection == null) {
            $$$reportNull$$$0(107);
        }
        ...
        Iterator it2 = collection.iterator();
        while (it2.hasNext()) {
            Integer numCompare2 = DescriptorVisibilities.compare(descriptorVisibility, ((CallableMemberDescriptor) it2.next()).getVisibility());
