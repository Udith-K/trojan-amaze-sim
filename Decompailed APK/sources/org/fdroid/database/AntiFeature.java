...
public final /* data */ class AntiFeature extends RepoAttribute {
    ...
    public static /* synthetic */ AntiFeature copy$default(AntiFeature antiFeature, long j, String str, Map map, Map map2, Map map3, int i, Object obj) {
        ...
        String str2 = str;
        if ((i & 4) != 0) {
            map = antiFeature.icon;
        }
        Map map4 = map;
        if ((i & 8) != 0) {
            map2 = antiFeature.name;
        }
        Map map5 = map2;
        if ((i & 16) != 0) {
            map3 = antiFeature.description;
        }
        return antiFeature.copy(j2, str2, map4, map5, map3);
    }
    ...
    public final AntiFeature copy(long repoId, String id, Map<String, FileV2> icon, Map<String, String> name, Map<String, String> description) {
        Intrinsics.checkNotNullParameter(id, "id");
        Intrinsics.checkNotNullParameter(icon, "icon");
        Intrinsics.checkNotNullParameter(name, "name");
        Intrinsics.checkNotNullParameter(description, "description");
        return new AntiFeature(repoId, id, icon, name, description);
    }
    ...
    public String toString() {
        return "AntiFeature(repoId=" + this.repoId + ", id=" + this.id + ", icon=" + this.icon + ", name=" + this.name + ", description=" + this.description + ")";
    }
    ...
    public /* synthetic */ AntiFeature(long j, String str, Map map, Map map2, Map map3, int i, DefaultConstructorMarker defaultConstructorMarker) {
