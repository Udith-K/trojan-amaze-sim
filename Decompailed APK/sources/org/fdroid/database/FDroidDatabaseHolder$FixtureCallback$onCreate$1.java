...
final class FDroidDatabaseHolder$FixtureCallback$onCreate$1 extends SuspendLambda implements Function2 {
    int label;
    final /* synthetic */ FDroidDatabaseHolder.FixtureCallback this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    FDroidDatabaseHolder$FixtureCallback$onCreate$1(FDroidDatabaseHolder.FixtureCallback fixtureCallback, Continuation continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        synchronized (FDroidDatabaseHolder.lock) {
            FDroidDatabaseInt fDroidDatabaseInt = FDroidDatabaseHolder.instance;
            if (fDroidDatabaseInt == null) {
                throw new IllegalStateException("DB not yet initialized");
            }
            ref$ObjectRef.element = fDroidDatabaseInt;
            Unit unit = Unit.INSTANCE;
        }
        this.this$0.fixture.prePopulateDb((FDroidDatabase) ref$ObjectRef.element);
