...
public final /* data */ class LocalizedIcon implements IFile {
    ...
    public final LocalizedIcon copy(long repoId, String packageName, String type, String locale, String name, String sha256, Long size, String ipfsCidV1) {
        Intrinsics.checkNotNullParameter(packageName, "packageName");
        Intrinsics.checkNotNullParameter(type, "type");
        Intrinsics.checkNotNullParameter(locale, "locale");
        Intrinsics.checkNotNullParameter(name, "name");
        return new LocalizedIcon(repoId, packageName, type, locale, name, sha256, size, ipfsCidV1);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof LocalizedIcon)) {
            return false;
        }
        LocalizedIcon localizedIcon = (LocalizedIcon) other;
    ...
    public String toString() {
        return "LocalizedIcon(repoId=" + this.repoId + ", packageName=" + this.packageName + ", type=" + this.type + ", locale=" + this.locale + ", name=" + this.name + ", sha256=" + this.sha256 + ", size=" + this.size + ", ipfsCidV1=" + this.ipfsCidV1 + ")";
    }
