...
public final /* data */ class PackageV2 {
    ...
    /* JADX INFO: compiled from: PackageV2.kt */
    @Metadata(d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\f\u0010\u0004\u001a\b\u0012\u0004\u0012\u00020\u00060\u0005¨\u0006\u0007"}, d2 = {"Lorg/fdroid/index/v2/PackageV2$Companion;", "", "<init>", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lorg/fdroid/index/v2/PackageV2;", "index_release"}, k = 1, mv = {2, 0, 0}, xi = 48)
    ...
    public /* synthetic */ PackageV2(int i, MetadataV2 metadataV2, Map map, SerializationConstructorMarker serializationConstructorMarker) {
        ...
        if ((i & 2) == 0) {
            this.versions = MapsKt.emptyMap();
        } else {
            this.versions = map;
        }
    }

    public static final /* synthetic */ void write$Self$index_release(PackageV2 self, CompositeEncoder output, SerialDescriptor serialDesc) {
        KSerializer[] kSerializerArr = $childSerializers;
        output.encodeSerializableElement(serialDesc, 0, MetadataV2$$serializer.INSTANCE, self.metadata);
        if (!output.shouldEncodeElementDefault(serialDesc, 1) && Intrinsics.areEqual(self.versions, MapsKt.emptyMap())) {
            return;
        }
        output.encodeSerializableElement(serialDesc, 1, kSerializerArr[1], self.versions);
    }
    ...
    public /* synthetic */ PackageV2(MetadataV2 metadataV2, Map map, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(metadataV2, (i & 2) != 0 ? MapsKt.emptyMap() : map);
    }
    ...
    public final void walkFiles(Function1 fileConsumer) {
        ...
        Iterator<T> it = this.versions.values().iterator();
        while (it.hasNext()) {
            ((PackageVersionV2) it.next()).walkFiles(fileConsumer);
        }
    }
}
