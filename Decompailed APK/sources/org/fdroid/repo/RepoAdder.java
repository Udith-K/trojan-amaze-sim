...
public final class RepoAdder {
    ...
    /* JADX INFO: renamed from: org.fdroid.repo.RepoAdder$fetchRepo$1, reason: invalid class name */
    /* JADX INFO: compiled from: RepoAdder.kt */
    static final class AnonymousClass1 extends ContinuationImpl {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            return RepoAdder.this.fetchRepo(null, null, null, null, null, null, this);
        }
    }
    ...
    /* JADX INFO: renamed from: getAddRepoState$database_release, reason: from getter */
    ...
    public final void fetchRepository$database_release(String url, Proxy proxy) {
        ...
        this.fetchJob = BuildersKt__Builders_commonKt.launch$default(GlobalScope.INSTANCE, this.coroutineContext, null, new RepoAdder$fetchRepository$1(this, url, proxy, null), 2, null);
    }
    ...
    /* JADX WARN: Type update failed for variable: r22v0 'this'  ??, new type: org.fdroid.repo.RepoAdder
    ...
    */
    ...
    public final FetchResult getFetchResult(String fetchUrlIn, Repository fetchedRepo) {
        ...
        String strTrimEnd = StringsKt.trimEnd(fetchUrlIn, '/');
        Object obj = null;
        if (repository != null) {
            if (Intrinsics.areEqual(strTrimEnd, StringsKt.trimEnd(repository.getAddress(), '/'))) {
                return new FetchResult.IsExistingRepository(repository.getRepoId());
            }
            Iterator it = Repository.getAllMirrors$default(repository, false, 1, null).iterator();
            while (true) {
                if (!it.hasNext()) {
                    break;
                }
                Object next = it.next();
                if (Intrinsics.areEqual(strTrimEnd, StringsKt.trimEnd(((Mirror) next).getUrl().toString(), '/'))) {
                    obj = next;
                    break;
                }
            }
            if (obj == null) {
                return new FetchResult.IsNewMirror(repository.getRepoId());
            }
            return new FetchResult.IsExistingMirror(repository.getRepoId());
        }
        boolean zAreEqual = Intrinsics.areEqual(strTrimEnd, StringsKt.trimEnd(fetchedRepo.getAddress(), '/'));
        Iterator<T> it2 = fetchedRepo.getMirrors$database_release().iterator();
        while (true) {
            if (!it2.hasNext()) {
                break;
            }
            Object next2 = it2.next();
            if (Intrinsics.areEqual(strTrimEnd, StringsKt.trimEnd(((org.fdroid.database.Mirror) next2).getUrl(), '/'))) {
                obj = next2;
                break;
            }
        }
    ...
    public final Repository addFetchedRepository$database_release() {
        ...
        if ((fetchResult instanceof FetchResult.IsNewRepository) || (fetchResult instanceof FetchResult.IsNewRepoAndNewMirror)) {
            ...
            if (certificate != null) {
                ...
                repository = (Repository) this.db.runInTransaction(new Callable() { // from class: org.fdroid.repo.RepoAdder$$ExternalSyntheticLambda6
                    ...
                    public final Object call() {
                        return RepoAdder.addFetchedRepository$lambda$8(this.f$0, newRepository, fetchResult, fetching);
                    }
                });
            } else {
            ...
            repository = (Repository) this.db.runInTransaction(new Callable() { // from class: org.fdroid.repo.RepoAdder$$ExternalSyntheticLambda7
                @Override // java.util.concurrent.Callable
                public final Object call() {
                    return RepoAdder.addFetchedRepository$lambda$10(this.f$0, existingRepoId$database_release, fetching);
                }
            });
        }
    ...
    public static final Repository addFetchedRepository$lambda$8(RepoAdder repoAdder, NewRepository newRepository, FetchResult fetchResult, Fetching fetching) {
        ...
        if (fetchResult instanceof FetchResult.IsNewRepoAndNewMirror) {
            repoAdder.repositoryDao.updateUserMirrors(jInsert, CollectionsKt.listOf(fetching.getFetchUrl()));
        }
        Repository repository = repoAdder.repositoryDao.getRepository(jInsert);
        if (repository != null) {
            return repository;
        }
    ...
    private final Repository getTempRepo(Uri uri, IndexFormatVersion indexFormatVersion, String username, String password) {
        ...
        return new Repository(0L, string, -1L, indexFormatVersion, "This is fake and will be replaced by real cert before saving in DB.", 0L, 0, -1L, username, password);
    }
}
