...
public abstract class ASN1BitString extends ASN1Primitive implements ASN1String, ASN1BitStringParser {
    ...
    public byte[] getBytes() {
        ...
        bArrCopyOfRange[length] = (byte) (((byte) (GF2Field.MASK << i)) & bArrCopyOfRange[length]);
    ...
    public int hashCode() {
        ...
        return (Arrays.hashCode(bArr, 0, length) * 257) ^ ((byte) ((GF2Field.MASK << i) & bArr[length]));
    }
    ...
    public int intValue() {
        ...
        byte[] bArr = this.contents;
        return i | ((((byte) (bArr[iMin] & (GF2Field.MASK << (bArr[0] & 255)))) & 255) << ((iMin - 1) * 8));
    }
