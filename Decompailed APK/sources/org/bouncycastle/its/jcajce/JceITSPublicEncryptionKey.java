...
public class JceITSPublicEncryptionKey extends ITSPublicEncryptionKey {
    ...
    public PublicKey getKey() {
        ...
        ECPoint eCPointNormalize = curve.decodePoint(eccCurvePoint.getEncodedPoint()).normalize();
        try {
            return this.helper.createKeyFactory("EC").generatePublic(new ECPublicKeySpec(EC5Util.convertPoint(eCPointNormalize), EC5Util.convertToSpec(byOID)));
        } catch (Exception e) {
