...
public class PKIXCertPathReviewer extends CertPathValidatorUtilities {
    ...
    */
    ...
    /* JADX WARN: Can't wrap try/catch for region: R(17:56|(3:158|58|59)(2:63|(3:160|65|59)(2:69|(2:76|77)(3:73|(1:75)(0)|77)))|181|78|83|(16:167|85|(1:87)(1:90)|169|91|(1:93)(1:96)|97|(2:100|98)|189|101|(2:104|102)|173|105|106|177|107)(1:114)|(1:119)(1:118)|120|(14:122|(2:124|(1:126))(1:127)|171|128|(2:130|(1:132))(1:133)|136|(2:138|(1:142))|145|175|146|179|147|188|151)(1:144)|143|145|175|146|179|147|188|151) */
        ...
        try {
            ...
            while (i3 < aSN1Sequence.size()) {
                ...
                if (ETSIQCObjectIdentifiers.id_etsi_qcs_QcCompliance.equals((ASN1Primitive) qCStatement.getStatementId())) {
                    ...
                    UntrustedInput untrustedInput = new UntrustedInput(qCStatement);
                    c = 2;
                    i2 = 1;
                    addNotification(new ErrorBundle(str, "CertPathReviewer.QcUnknownStatement", new Object[]{statementId, untrustedInput}), i);
                    z = true;
                    i3 += i2;
                    c2 = c;
                    str2 = str;
