...
public class EtsiTs102941TypesEnrolment {
    ...
    static {
        OERDefinition.Builder builderTypeName = OERDefinition.enumeration(OERDefinition.enumItem("ok", BigInteger.ZERO), "cantparse", "badcontenttype", "imnottherecipient", "unknownencryptionalgorithm", "decryptionfailed", "unknownits", "invalidsignature", "invalidencryptionkey", "baditsstatus", "incompleterequest", "deniedpermissions", "invalidkeys", "deniedrequest", OERDefinition.extension(new Object[0])).typeName("EnrolmentResponseCode");
        EnrolmentResponseCode = builderTypeName;
        InnerEcResponse = OERDefinition.seq(OERDefinition.octets(16).label("requestHash"), builderTypeName.label("responseCode"), OERDefinition.optional(EtsiTs103097Module.EtsiTs103097Certificate.label("certificate")), OERDefinition.extension(new Object[0])).typeName("InnerEcResponse");
