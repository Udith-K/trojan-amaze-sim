...
public class EtsiTs102941TrustLists {
    ...
    static {
        ...
        OERDefinition.Builder builderTypeName = builder.typeName("CrlEntry");
        ...
        OERDefinition.Builder builderLabel = builder2.label("version");
        OERDefinition.Builder builder3 = Ieee1609Dot2BaseTypes.Time32;
        ToBeSignedCrl = OERDefinition.seq(builderLabel, builder3.label("thisUpdate"), builder3.label("nextUpdate"), builderTypeName2.label("entries"), OERDefinition.extension(new Object[0])).typeName("ToBeSignedCrl");
        ...
        OERDefinition.Builder builderTypeName6 = OERDefinition.seq(builder4.label("aaCertificate"), builderTypeName3.label("accessPoint")).typeName("AaEntry");
        AaEntry = builderTypeName6;
        OERDefinition.Builder builderTypeName7 = OERDefinition.seq(builder4.label("eaCertificate"), builderTypeName3.label("aaAccessPoint"), OERDefinition.optional(builderTypeName3.label("itsAccessPoint"))).typeName("EaEntry");
        EaEntry = builderTypeName7;
        OERDefinition.Builder builderTypeName8 = OERDefinition.seq(builder4.label("selfsignedRootCa"), OERDefinition.optional(builder4.label("successorTo"))).typeName("RootCaEntry");
        RootCaEntry = builderTypeName8;
        OERDefinition.Builder builderTypeName9 = OERDefinition.seq(builder4.label("selfSignedTLMCertificate"), OERDefinition.optional(builder4.label("successorTo")), builderTypeName3.label("accessPoint")).typeName("TlmEntry");
        TlmEntry = builderTypeName9;
        OERDefinition.Builder builderTypeName10 = OERDefinition.choice(builder.label("cert"), builderTypeName4.label("dc"), OERDefinition.extension(new Object[0])).typeName("CtlDelete");
        ...
        OERDefinition.Builder builderTypeName14 = OERDefinition.seq(builder2.label("version"), builder3.label("nextUpdate"), OERDefinition.bool().label("isFullCtl"), OERDefinition.integer(0L, 255L).label("ctlSequence"), builderTypeName13.label("ctlCommands"), OERDefinition.extension(new Object[0])).typeName("CtlFormat");
