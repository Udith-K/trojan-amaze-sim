...
public class Ieee1609Dot2BaseTypes {
    ...
    static {
        ...
        OERDefinition.Builder builderTypeName2 = OERDefinition.integer(0L, 65535L).typeName("UINT16");
        UINT16 = builderTypeName2;
        OERDefinition.Builder builderTypeName3 = OERDefinition.integer(0L, BodyPartID.bodyIdMax).typeName("UINT32");
        ...
        ValidityPeriod = OERDefinition.seq(builderTypeName9.label("start"), builderTypeName10.label("duration")).typeName("ValidityPeriod");
        ...
        EciesP256EncryptedKey = OERDefinition.seq(builderTypeName12.copy().label("v"), OERDefinition.octets(16).label("c"), OERDefinition.octets(16).label("t")).typeName("EciesP256EncryptedKey");
        ...
        OERDefinition.Builder builderTypeName31 = OERDefinition.seq(builderTypeName.label("region"), builderTypeName5.label("subregions")).typeName("RegionAndSubregions");
        ...
        OERDefinition.Builder builderTypeName33 = OERDefinition.seq(builderTypeName29.label("country"), builderTypeName32.label("regionAndSubregions")).typeName("CountryAndSubregions");
        ...
        OERDefinition.Builder builderTypeName39 = builderTypeName36.copy().typeName("Longitude");
        Longitude = builderTypeName39;
        OERDefinition.Builder builderTypeName40 = builderTypeName37.copy().typeName("Latitude");
        Latitude = builderTypeName40;
        ThreeDLocation = OERDefinition.seq(builderTypeName40.label("latitude"), builderTypeName39.label("longitude"), builderTypeName38.label("elevation")).typeName("ThreeDLocation");
        ...
        OERDefinition.Builder builderTypeName44 = OERDefinition.seq(builderTypeName41.label("center"), builderTypeName2.label("radius")).typeName("CircularRegion");
