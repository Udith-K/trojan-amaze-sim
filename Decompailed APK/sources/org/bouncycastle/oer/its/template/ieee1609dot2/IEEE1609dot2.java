...
public class IEEE1609dot2 {
    ...
    static {
        ...
        OERDefinition.Builder builderTypeName4 = OERDefinition.seq(builderLabel, builder2.label("crlSeries"), OERDefinition.extension(new Object[0])).typeName("MissingCrlIdentifier");
        ...
        OERDefinition.Builder builderTypeName7 = builder3.typeName("PreSharedKeyRecipientInfo");
        PreSharedKeyRecipientInfo = builderTypeName7;
        OERDefinition.Builder builder4 = Ieee1609Dot2BaseTypes.EciesP256EncryptedKey;
        OERDefinition.Builder builderTypeName8 = OERDefinition.choice(builder4.label("eciesNistP256"), builder4.label("eciesBrainpoolP256r1"), OERDefinition.extension(new Object[0])).typeName("EncryptedDataEncryptionKey");
        EncryptedDataEncryptionKey = builderTypeName8;
        OERDefinition.Builder builderTypeName9 = OERDefinition.seq(builder3.label("recipientId"), builderTypeName8.label("encKey")).typeName("PKRecipientInfo");
        ...
        OERDefinition.Builder builderTypeName12 = OERDefinition.seq(builder3.label("recipientId"), builderTypeName11.label("encKey")).typeName("SymmRecipientInfo");
        ...
        OERDefinition.Builder builderTypeName22 = OERDefinition.choice(builderTypeName21.label("linkageData"), Ieee1609Dot2BaseTypes.Hostname.label("name"), OERDefinition.octets(1, 64).label("binaryId"), OERDefinition.nullValue().label(ZipSigner.KEY_NONE), OERDefinition.extension(new Object[0])).typeName("CertificateId");
        CertificateId = builderTypeName22;
        OERDefinition.Builder builderTypeName23 = OERDefinition.seq(builderTypeName22.label("id"), builder.label("cracaId"), builder2.label("crlSeries"), Ieee1609Dot2BaseTypes.ValidityPeriod.label("validityPeriod"), OERDefinition.optional(Ieee1609Dot2BaseTypes.GeographicRegion.label("region"), Ieee1609Dot2BaseTypes.SubjectAssurance.label("assuranceLevel"), Ieee1609Dot2BaseTypes.SequenceOfPsidSsp.label("appPermissions"), builderTypeName20.label("certIssuePermissions"), builderTypeName20.label("certRequestPermissions"), OERDefinition.nullValue().label("canRequestRollover"), Ieee1609Dot2BaseTypes.PublicEncryptionKey.label("encryptionKey")), builderTypeName18.label("verifyKeyIndicator"), OERDefinition.extension(new Object[0])).typeName("ToBeSignedCertificate");
        ToBeSignedCertificate = builderTypeName23;
        OERDefinition.Builder builderLabel2 = builder3.label("sha256AndDigest");
        OERDefinition.Builder builder5 = Ieee1609Dot2BaseTypes.HashAlgorithm;
        OERDefinition.Builder builderTypeName24 = OERDefinition.choice(builderLabel2, builder5.label("self"), OERDefinition.extension(builder3.label("sha384AndDigest"))).typeName("IssuerIdentifier");
        ...
        OERDefinition.Builder builderLabel3 = builder6.label("version");
        OERDefinition.Builder builderLabel4 = builderTypeName25.label(BonjourPeer.TYPE);
        OERDefinition.Builder builderLabel5 = builderTypeName24.label("issuer");
        OERDefinition.Builder builderLabel6 = builderTypeName23.label("toBeSigned");
        OERDefinition.Builder builder7 = Ieee1609Dot2BaseTypes.Signature;
        OERDefinition.Builder builderTypeName26 = OERDefinition.seq(builderLabel3, builderLabel4, builderLabel5, builderLabel6, OERDefinition.optional(builder7.label("signature"))).label("signature").typeName("CertificateBase");
        ...
        ExplicitCertificate = builderTypeName26.typeName("ExplicitCertificate").replaceChild(1, builderTypeName25.validSwitchValue(explicitOrdinal).label(BonjourPeer.TYPE));
        ImplicitCertificate = builderTypeName26.typeName("ImplicitCertificate").replaceChild(1, builderTypeName25.validSwitchValue(implicitOrdinal).label(BonjourPeer.TYPE));
        ...
        }).label("tbsData"), builderTypeName29.label("signer"), builder7.label("signature")).typeName("SignedData");
        ...
        CounterSignature = OERDefinition.seq(builder6.label("protocolVersion"), builderTypeName31.label("content")).typeName("CounterSignature");
        OERDefinition.Builder builderTypeName32 = OERDefinition.seq(builder6.validSwitchValue(new ASN1Integer(3L)).label("protocolVersion"), builderTypeName31.label("content")).typeName("Ieee1609Dot2Data");
