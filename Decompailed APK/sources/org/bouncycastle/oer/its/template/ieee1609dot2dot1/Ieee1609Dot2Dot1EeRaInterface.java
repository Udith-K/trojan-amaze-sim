...
public class Ieee1609Dot2Dot1EeRaInterface {
    ...
    static {
        ...
        OERDefinition.Builder builderLabel = builderTypeName.label("signingExpansion");
        OERDefinition.Builder builder = Ieee1609Dot2BaseTypes.PublicEncryptionKey;
        OERDefinition.Builder builderTypeName2 = OERDefinition.seq(builderLabel, builder.label("encryptionKey"), builderTypeName.label("encryptionExpansion")).typeName("ButterflyParamsOriginal");
        ButterflyParamsOriginal = builderTypeName2;
        OERDefinition.Builder builderTypeName3 = OERDefinition.choice(builderTypeName2.label("original"), builderTypeName.label("unified"), builderTypeName.label("compactUnified"), builder.label("encryptionKey"), OERDefinition.extension(new Object[0])).typeName("AdditionalParams");
