...
public class EtsiTs103097ExtensionModule {
    ...
    static {
        ...
        OERDefinition.Builder builderTypeName = OERDefinition.integer(0L, 255L).validSwitchValue(aSN1Integer, aSN1Integer2).typeName("ExtId");
        ExtId = builderTypeName;
        ...
        OERDefinition.Builder builderTypeName2 = OERDefinition.seq(builder.label("issuerId"), OERDefinition.optional(OERDefinition.integer(0L, 255L).label("lastKnownCtlSequence"))).typeName("EtsiTs102941CtlRequest");
        EtsiTs102941CtlRequest = builderTypeName2;
        EtsiTs102941DeltaCtlRequest = builderTypeName2.typeName("EtsiTs102941DeltaCtlRequest");
        OERDefinition.Builder builderTypeName3 = OERDefinition.seq(builderTypeName.label("id"), OERDefinition.aSwitch(new Switch() { // from class: org.bouncycastle.oer.its.template.etsi103097.extension.EtsiTs103097ExtensionModule.1
        ...
        Extension = builderTypeName3;
        EtsiOriginatingHeaderInfoExtension = builderTypeName3.typeName("EtsiOriginatingHeaderInfoExtension");
    }
}
