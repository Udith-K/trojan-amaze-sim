...
public class JcaCertStoreBuilder {
    ...
    public CertStore build() throws GeneralSecurityException {
        ...
        return obj instanceof String ? CertStore.getInstance(this.type, collectionCertStoreParametersConvertHolders, (String) obj) : obj instanceof Provider ? CertStore.getInstance(this.type, collectionCertStoreParametersConvertHolders, (Provider) obj) : CertStore.getInstance(this.type, collectionCertStoreParametersConvertHolders);
    }
