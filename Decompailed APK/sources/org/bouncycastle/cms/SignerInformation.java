...
public class SignerInformation {
    ...
    protected final SignerInfo f76info;
    ...
    protected SignerInformation(SignerInformation signerInformation) {
        this(signerInformation, signerInformation.f76info);
    }
    ...
    public static SignerInformation addCounterSigners(SignerInformation signerInformation, SignerInformationStore signerInformationStore) {
        SignerInfo signerInfo = signerInformation.f76info;
    ...
    private boolean doVerify(SignerInformationVerifier signerInformationVerifier) throws CMSException {
        ...
        try {
            ContentVerifier contentVerifier = signerInformationVerifier.getContentVerifier(this.encryptionAlgorithm, this.f76info.getDigestAlgorithm());
            try {
    ...
    private void verifyAlgorithmIdentifierProtectionAttribute(AttributeTable attributeTable) throws CMSException {
        ...
        if (attributeTable != null) {
            ...
            if (all.size() > 0) {
                ...
                if (!CMSUtils.isEquivalent(cMSAlgorithmProtection.getDigestAlgorithm(), this.f76info.getDigestAlgorithm())) {
                    throw new CMSException("CMS Algorithm Identifier Protection check failed for digestAlgorithm");
                }
                if (!CMSUtils.isEquivalent(cMSAlgorithmProtection.getSignatureAlgorithm(), this.f76info.getDigestEncryptionAlgorithm())) {
    ...
    public int getVersion() {
        return this.f76info.getVersion().intValueExact();
    }
