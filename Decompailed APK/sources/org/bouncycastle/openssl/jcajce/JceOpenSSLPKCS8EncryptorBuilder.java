    ...
    public OutputEncryptor build() throws OperatorCreationException {
        ...
        try {
            ...
            if (PEMUtilities.isPKCS5Scheme2(this.algOID)) {
                ...
                AlgorithmParameters algorithmParametersGenerateParameters = this.paramGen.generateParameters();
                this.params = algorithmParametersGenerateParameters;
                try {
                    EncryptionScheme encryptionScheme = new EncryptionScheme(this.algOID, ASN1Primitive.fromByteArray(algorithmParametersGenerateParameters.getEncoded()));
