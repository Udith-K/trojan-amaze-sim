...
public class Base32Encoder implements Encoder {
    ...
    public int decode(byte[] bArr, int i, int i2, OutputStream outputStream) throws IOException {
        ...
        int iNextI10 = nextI(bArr, iNextI, i19);
        int iNextI11 = nextI(bArr, iNextI10 + 1, i19);
        int iNextI12 = nextI(bArr, iNextI11 + 1, i19);
        int iNextI13 = nextI(bArr, iNextI12 + 1, i19);
        int iNextI14 = nextI(bArr, iNextI13 + 1, i19);
        int iNextI15 = nextI(bArr, iNextI14 + 1, i19);
        int iNextI16 = nextI(bArr, iNextI15 + 1, i19);
        return i7 + decodeLastBlock(outputStream, (char) bArr[iNextI10], (char) bArr[iNextI11], (char) bArr[iNextI12], (char) bArr[iNextI13], (char) bArr[iNextI14], (char) bArr[iNextI15], (char) bArr[iNextI16], (char) bArr[nextI(bArr, iNextI16 + 1, i19)]);
    }
