...
public class VMPCMac implements Mac {
    ...
    public void update(byte b) throws IllegalStateException {
        ...
        this.s = b4;
        byte b5 = (byte) (b ^ bArr[(bArr[bArr[b4 & 255] & 255] + 1) & GF2Field.MASK]);
        byte b6 = this.x4;
        byte b7 = this.x3;
        byte b8 = bArr[(b6 + b7) & GF2Field.MASK];
        this.x4 = b8;
        byte b9 = this.x2;
        byte b10 = bArr[(b7 + b9) & GF2Field.MASK];
        this.x3 = b10;
        byte b11 = this.x1;
        byte b12 = bArr[(b9 + b11) & GF2Field.MASK];
        this.x2 = b12;
        byte b13 = bArr[(b11 + b4 + b5) & GF2Field.MASK];
        this.x1 = b13;
        byte[] bArr2 = this.T;
        byte b14 = this.g;
