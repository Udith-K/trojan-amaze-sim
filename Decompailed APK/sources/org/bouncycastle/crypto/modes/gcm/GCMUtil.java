...
public abstract class GCMUtil {
    ...
    static void multiply(byte[] bArr, long[] jArr) {
        ...
        Pack.longToBigEndian(((jReverse7 ^ ((jImplMul64 ^ jReverse5) ^ jReverse6)) ^ (((j3 ^ (j3 >>> 1)) ^ (j3 >>> 2)) ^ (j3 >>> 7))) ^ ((jImplMul643 << 57) ^ ((jImplMul643 << 63) ^ (jImplMul643 << 62))), bArr, 8);
    }
    ...
    public static void multiply(long[] jArr, long[] jArr2) {
        ...
        jArr[0] = jReverse5 ^ (((jImplMul643 >>> 2) ^ ((jImplMul643 >>> 1) ^ jImplMul643)) ^ (jImplMul643 >>> 7));
