...
public class Zuc128CoreEngine implements StreamCipher, Memoable {
    ...
    int F() {
        ...
        byte b = bArr[iL1 >>> 24];
        byte[] bArr2 = S1;
        iArr3[0] = MAKEU32(b, bArr2[(iL1 >>> 16) & GF2Field.MASK], bArr[(iL1 >>> 8) & GF2Field.MASK], bArr2[iL1 & GF2Field.MASK]);
        this.F[1] = MAKEU32(bArr[iL2 >>> 24], bArr2[(iL2 >>> 16) & GF2Field.MASK], bArr[(iL2 >>> 8) & GF2Field.MASK], bArr2[iL2 & GF2Field.MASK]);
        return i4;
    }
