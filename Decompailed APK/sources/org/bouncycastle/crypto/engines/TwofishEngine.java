...
public final class TwofishEngine implements BlockCipher {
    ...
    public TwofishEngine() {
        for (int i = 0; i < 256; i++) {
            byte[][] bArr = P;
            int i2 = bArr[0][i] & 255;
            int iMx_X = Mx_X(i2) & GF2Field.MASK;
            int iMx_Y = Mx_Y(i2) & GF2Field.MASK;
            int i3 = bArr[1][i] & GF2Field.MASK;
            int[] iArr = {i2, i3};
            int[] iArr2 = {iMx_X, Mx_X(i3) & GF2Field.MASK};
            int[] iArr3 = {iMx_Y, Mx_Y(i3) & GF2Field.MASK};
