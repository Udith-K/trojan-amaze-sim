...
class LongArray implements Cloneable {
    ...
    private static long interleave2_32to64(int i) {
        ...
        return (((long) i2) & BodyPartID.bodyIdMax) | ((((long) ((sArr[i >>> 24] << 16) | sArr[(i >>> 16) & GF2Field.MASK])) & BodyPartID.bodyIdMax) << 32);
    }
    ...
    public LongArray modInverse(int i, int[] iArr) {
        ...
        while (true) {
            if (i4 < 0) {
                i4 = -i4;
                iArr2[i5] = i3;
                iArr3[i5] = iDegreeFrom;
                i5 = 1 - i5;
                i3 = iArr2[i5];
                iDegreeFrom = iArr3[i5];
            }
            int i6 = 1 - i5;
            longArrayArr[i5].addShiftedByBitsSafe(longArrayArr[i6], iArr2[i6], i4);
            int iDegreeFrom2 = longArrayArr[i5].degreeFrom(i3);
            if (iDegreeFrom2 == 0) {
                return longArrayArr2[i6];
            }
            int i7 = iArr3[i6];
            longArrayArr2[i5].addShiftedByBitsSafe(longArrayArr2[i6], i7, i4);
            int i8 = i7 + i4;
            if (i8 > iDegreeFrom) {
                iDegreeFrom = i8;
            } else if (i8 == iDegreeFrom) {
                iDegreeFrom = longArrayArr2[i5].degreeFrom(iDegreeFrom);
            }
            i4 += iDegreeFrom2 - i3;
            i3 = iDegreeFrom2;
        }
    ...
    public LongArray modMultiplyAlt(LongArray longArray, int i, int[] iArr) {
        ...
        while (i15 < 8) {
            int i16 = i14 + i8;
            shiftUp(jArr2, i5, jArr2, i16, i8, i15);
            i15++;
            i14 = i16;
        }
        int i17 = 15;
        ...
        while (true) {
            ...
            while (true) {
                ...
                while (true) {
                    int i22 = ((int) j2) & i17;
                    if (i22 != 0) {
                        add(jArr2, iArr2[i22] + i19, jArr2, i20, i8);
                    }
                    i21++;
                    if (i21 == 8) {
                        break;
        ...
        while (true) {
            ...
            if ((((long) i24) & 1) == 0) {
                addShiftedUp(jArr2, iArr2[i24 >>> 1], jArr2, iArr2[i24], i7, 16);
            } else {
                distribute(jArr2, iArr2[i24], iArr2[i23 - 2], iArr2[1], i7);
            }
            i23 = i24;
        }
    }
