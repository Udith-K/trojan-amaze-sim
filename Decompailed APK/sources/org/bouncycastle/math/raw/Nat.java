...
public abstract class Nat {
    ...
    public static int mulAddTo(int i, int[] iArr, int i2, int[] iArr2, int i3, int[] iArr3, int i4) {
        ...
        for (int i5 = 0; i5 < i; i5++) {
            int i6 = i4 + i;
            long jMulWordAddTo = j + (((long) mulWordAddTo(i, iArr[i2 + i5], iArr2, i3, iArr3, i4)) & 4294967295L) + (((long) iArr3[i6]) & 4294967295L);
            iArr3[i6] = (int) jMulWordAddTo;
            j = jMulWordAddTo >>> 32;
            i4++;
        }
        return (int) j;
    ...
    public static int mulAddTo(int i, int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            int i3 = i2 + i;
            long jMulWordAddTo = j + (((long) mulWordAddTo(i, iArr[i2], iArr2, 0, iArr3, i2)) & 4294967295L) + (((long) iArr3[i3]) & 4294967295L);
