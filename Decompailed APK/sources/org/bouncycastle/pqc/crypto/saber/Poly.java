    ...
    private void cbd(short[] sArr, byte[] bArr, int i) {
        ...
        if (this.engine.getSABER_MU() == 6) {
            for (int i2 = 0; i2 < this.SABER_N / 4; i2++) {
                int iLoad_littleendian = (int) load_littleendian(bArr, i + (i2 * 3), 3);
                int i3 = 0;
                for (int i4 = 0; i4 < 3; i4++) {
                    i3 += (iLoad_littleendian >> i4) & 2396745;
                }
                iArr[0] = i3 & 7;
                iArr[1] = (i3 >>> 6) & 7;
                iArr[2] = (i3 >>> 12) & 7;
        ...
        if (this.engine.getSABER_MU() == 8) {
            for (int i6 = 0; i6 < this.SABER_N / 4; i6++) {
                int i7 = i6 * 4;
                int iLoad_littleendian2 = (int) load_littleendian(bArr, i + i7, 4);
                int i8 = 0;
                for (int i9 = 0; i9 < 4; i9++) {
                    i8 += (iLoad_littleendian2 >>> i9) & 286331153;
                }
                iArr[0] = i8 & 15;
                iArr[1] = (i8 >>> 8) & 15;
                iArr[2] = (i8 >>> 16) & 15;
        ...
        if (this.engine.getSABER_MU() == 10) {
            ...
            while (i10 < this.SABER_N / 4) {
                long jLoad_littleendian = load_littleendian(bArr, i + (i10 * 5), 5);
                long j = 0;
                for (int i11 = 0; i11 < 5; i11++) {
                    j += (jLoad_littleendian >>> i11) & 35468117025L;
                }
                iArr[0] = (int) (j & 31);
                iArr[1] = (int) ((j >>> 10) & 31);
                iArr[2] = (int) ((j >>> 20) & 31);
