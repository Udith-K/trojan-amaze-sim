...
class FrodoEngine {
    ...
    private byte[] decode(short[] sArr) {
        ...
        for (int i3 = 0; i3 < 8; i3++) {
            ...
            for (int i4 = 0; i4 < 8; i4++) {
                ...
                int i6 = this.D;
                int i7 = this.B;
                j |= ((long) (((short) ((i5 + (1 << ((i6 - i7) - 1))) >> (i6 - i7))) & s)) << (i7 * i4);
                i2++;
            }
            int i8 = 0;
            while (true) {
    ...
    private short[] unpack(byte[] bArr, int i, int i2) {
        ...
        while (s < i3 && (s2 < bArr.length || (s2 == bArr.length && b > 0))) {
            ...
            while (true) {
                ...
                sArr[s] = (short) (((sArr[s] & 65535) + ((((byte) ((((b2 & 255) >>> ((b & 255) - iMin)) & (s3 & 65535)) & GF2Field.MASK)) & 255) << ((this.D - (b3 & 255)) - iMin))) & 65535);
                b3 = (byte) (b3 + iMin);
                byte b4 = (byte) (b - iMin);
    ...
    public void kem_dec(byte[] bArr, byte[] bArr2, byte[] bArr3) {
        ...
        int i15 = this.n;
        short[] sArrMatrix_add = matrix_add(matrix_mul(sArrSample_matrix, 8, i15, sArrGenMatrix, i15, i15), sArrSample_matrix2, 8, this.n);
    ...
    public void kem_enc(byte[] bArr, byte[] bArr2, byte[] bArr3, SecureRandom secureRandom) {
        ...
        int i6 = this.n;
        byte[] bArrPack = pack(matrix_add(matrix_mul(sArrSample_matrix, 8, i6, sArrGenMatrix, i6, i6), sArrSample_matrix2, 8, this.n));
    ...
    public void kem_keypair(byte[] bArr, byte[] bArr2, SecureRandom secureRandom) {
        ...
        for (int i10 = 0; i10 < 8; i10++) {
            ...
            while (true) {
                int i12 = this.n;
                if (i11 < i12) {
                    System.arraycopy(Pack.shortToLittleEndian(sArrSample_matrix[(i12 * i10) + i11]), 0, bArr2, this.len_s_bytes + this.len_pk_bytes + (this.n * i10 * 2) + (i11 * 2), 2);
                    i11++;
                }
            }
        }
