...
class SABERCipherSpi extends CipherSpi {
    ...
    protected Key engineUnwrap(byte[] bArr, String str, int i) throws NoSuchAlgorithmException, InvalidKeyException {
        ...
        try {
            ...
            byte[] bArrExtractSecret = sABERKEMExtractor.extractSecret(Arrays.copyOfRange(bArr, 0, sABERKEMExtractor.getInputSize()));
            ...
            byte[] bArrCopyOfRange = Arrays.copyOfRange(bArr, sABERKEMExtractor.getInputSize(), bArr.length);
