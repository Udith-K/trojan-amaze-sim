...
class FrodoCipherSpi extends CipherSpi {
    ...
    protected Key engineUnwrap(byte[] bArr, String str, int i) throws NoSuchAlgorithmException, InvalidKeyException {
        ...
        try {
            ...
            byte[] bArrExtractSecret = frodoKEMExtractor.extractSecret(Arrays.copyOfRange(bArr, 0, frodoKEMExtractor.getInputSize()));
            ...
            byte[] bArrCopyOfRange = Arrays.copyOfRange(bArr, frodoKEMExtractor.getInputSize(), bArr.length);
