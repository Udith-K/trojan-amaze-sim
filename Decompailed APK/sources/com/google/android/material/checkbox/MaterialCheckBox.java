...
public class MaterialCheckBox extends AppCompatCheckBox {
    ...
    public void setCheckedState(int i) {
        ...
        if (this.checkedState != i) {
            ...
            if (Build.VERSION.SDK_INT >= 26 && (autofillManagerM = AndroidAutofill$$ExternalSyntheticApiModelOutline1.m(getContext().getSystemService(AndroidAutofill$$ExternalSyntheticApiModelOutline0.m()))) != null) {
