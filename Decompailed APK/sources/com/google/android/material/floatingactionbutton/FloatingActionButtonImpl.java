...
abstract class FloatingActionButtonImpl {
    ...
    void show(InternalVisibilityChangedListener internalVisibilityChangedListener, boolean z) {
        ...
        if (shouldAnimateVisibilityChange()) {
            ...
            animatorSetCreateDefaultAnimator.addListener(new AnimatorListenerAdapter(z, internalVisibilityChangedListener) { // from class: com.google.android.material.floatingactionbutton.FloatingActionButtonImpl.2
                final /* synthetic */ boolean val$fromUser;
                final /* synthetic */ InternalVisibilityChangedListener val$listener;
