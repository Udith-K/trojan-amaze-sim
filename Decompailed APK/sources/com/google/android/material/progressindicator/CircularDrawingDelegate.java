...
final class CircularDrawingDelegate extends DrawingDelegate {
    ...
    void adjustCanvas(Canvas canvas, Rect rect, float f, boolean z, boolean z2) {
        ...
        this.displayedCornerRadius = Math.min(((CircularProgressIndicatorSpec) baseProgressIndicatorSpec2).trackThickness / 2, ((CircularProgressIndicatorSpec) baseProgressIndicatorSpec2).trackCornerRadius) * f;
        ...
        if (z || z2) {
            if ((z && ((CircularProgressIndicatorSpec) baseProgressIndicatorSpec3).showAnimationBehavior == 2) || (z2 && ((CircularProgressIndicatorSpec) baseProgressIndicatorSpec3).hideAnimationBehavior == 1)) {
                this.adjustedRadius = f4 + (((1.0f - f) * ((CircularProgressIndicatorSpec) baseProgressIndicatorSpec3).trackThickness) / 2.0f);
