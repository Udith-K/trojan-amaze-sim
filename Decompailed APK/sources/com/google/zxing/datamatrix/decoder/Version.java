...
public final class Version {
    ...
    private static Version[] buildVersions() {
        ...
        Version version13 = new Version(13, 44, 44, 20, 20, new ECBlocks(56, new ECB(i, 144)));
        Version version14 = new Version(14, 48, 48, 22, 22, new ECBlocks(68, new ECB(i, 174)));
        int i6 = 2;
        Version version15 = new Version(15, 52, 52, 24, 24, new ECBlocks(42, new ECB(i6, 102)));
        Version version16 = new Version(16, 64, 64, 14, 14, new ECBlocks(56, new ECB(i6, 140)));
        int i7 = 4;
        Version version17 = new Version(17, 72, 72, 16, 16, new ECBlocks(36, new ECB(i7, 92)));
        Version version18 = new Version(18, 80, 80, 18, 18, new ECBlocks(48, new ECB(i7, 114)));
        Version version19 = new Version(19, 88, 88, 20, 20, new ECBlocks(56, new ECB(i7, 144)));
        Version version20 = new Version(20, 96, 96, 22, 22, new ECBlocks(68, new ECB(i7, 174)));
        int i8 = 6;
