...
public abstract class OneDReader implements Reader {
    ...
    public Result decode(BinaryBitmap binaryBitmap, Map map) throws NotFoundException {
        try {
            ...
            if (map != null && map.containsKey(DecodeHintType.TRY_HARDER) && binaryBitmap.isRotateSupported()) {
                ...
                Map resultMetadata = resultDoDecode.getResultMetadata();
                int iIntValue = 270;
    ...
    */
    private com.google.zxing.Result doDecode(com.google.zxing.BinaryBitmap r22, java.util.Map r23) throws com.google.zxing.NotFoundException {
        /*
