    ...
    private void onResourceReady(Resource resource, Object obj, DataSource dataSource, boolean z) {
        ...
        try {
            ...
            if (list != null) {
                ...
                while (it.hasNext()) {
                    zOnResourceReady |= ((RequestListener) it.next()).onResourceReady(obj, this.model, this.target, dataSource, zIsFirstReadyResource);
                }
            } else {
                zOnResourceReady = false;
            }
            RequestListener requestListener = this.targetListener;
            if (requestListener == null || !requestListener.onResourceReady(obj, this.model, this.target, dataSource, zIsFirstReadyResource)) {
                z2 = false;
            }
