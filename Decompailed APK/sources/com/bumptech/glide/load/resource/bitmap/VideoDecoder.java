...
public class VideoDecoder implements ResourceDecoder {
    ...
    public Resource decode(Object obj, int i, int i2, Options options) throws IOException {
        ...
        try {
            ...
            return BitmapResource.obtain(decodeFrame(obj, mediaMetadataRetrieverBuild, jLongValue, num.intValue(), i, i2, downsampleStrategy2), this.bitmapPool);
        } finally {
    ...
    */
    private boolean isUnsupportedFormat(java.lang.Object r6, android.media.MediaMetadataRetriever r7) {
        /*
            r5 = this;
        ...
        L1f:
            ...
            com.bumptech.glide.load.resource.bitmap.VideoDecoder$MediaInitializer r1 = r5.initializer     // Catch: java.lang.Throwable -> L4a
