        ...
        */
        ...
        private final void buildTrieRecursive(long j, Buffer buffer, int i, List list, int i2, int i3, List list2) {
            ...
            if (byteString.getByte(i8) != byteString2.getByte(i8)) {
                ...
                long intCount = j + getIntCount(buffer) + ((long) 2) + ((long) (i12 * 2));
                buffer.writeInt(i12);
                buffer.writeInt(i5);
                ...
                while (i4 < i3) {
                    ...
                    while (true) {
                        if (i16 >= i3) {
                            ...
                            if (b2 != ((ByteString) list.get(i16)).getByte(i8)) {
                                i6 = i16;
                                break;
                            }
                            i16++;
            ...
            int i17 = 0;
            for (int i18 = i8; i18 < iMin && byteString.getByte(i18) == byteString2.getByte(i18); i18++) {
                i17++;
            }
            long intCount2 = j + getIntCount(buffer) + ((long) 2) + ((long) i17) + 1;
            buffer.writeInt(-i17);
            buffer.writeInt(i5);
            int i19 = i17 + i8;
            while (i8 < i19) {
