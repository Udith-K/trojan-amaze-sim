...
class ActionMenuPresenter extends BaseMenuPresenter implements ActionProvider.SubUiVisibilityListener {
    ...
    public boolean flagActionItems() {
        ...
        while (i10 < size) {
            ?? r15 = (MenuItemImpl) visibleItems.get(i10);
            if (r15.requiresActionButton()) {
                View itemView = r02.getItemView(r15, view, viewGroup);
                ...
                r15.setIsActionButton(true);
                r0 = r3;
                i2 = size;
            } else if (r15.requestsActionButton()) {
                ...
                i2 = size;
                if (z3) {
                    View itemView2 = r02.getItemView(r15, null, viewGroup);
                    if (r02.mStrictWidthLimit) {
                ...
                if (z3 && groupId2 != 0) {
                    ...
                    for (int i12 = 0; i12 < i10; i12++) {
                        MenuItemImpl menuItemImpl2 = (MenuItemImpl) visibleItems.get(i12);
