...
public class CircularProgressDrawable extends Drawable implements Animatable {
    ...
    private int evaluateColorChange(float f, int i, int i2) {
        return ((((i >> 24) & GF2Field.MASK) + ((int) ((((i2 >> 24) & GF2Field.MASK) - r0) * f))) << 24) | ((((i >> 16) & GF2Field.MASK) + ((int) ((((i2 >> 16) & GF2Field.MASK) - r1) * f))) << 16) | ((((i >> 8) & GF2Field.MASK) + ((int) ((((i2 >> 8) & GF2Field.MASK) - r2) * f))) << 8) | ((i & GF2Field.MASK) + ((int) (f * ((i2 & GF2Field.MASK) - r8))));
    }
