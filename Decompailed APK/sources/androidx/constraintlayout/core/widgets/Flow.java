...
public class Flow extends VirtualLayout {
    ...
    private void measureChainWrap(ConstraintWidget[] constraintWidgetArr, int i, int i2, int i3, int[] iArr) {
        ...
        while (i17 < size) {
            WidgetsList widgetsList3 = (WidgetsList) this.mChainList.get(i17);
            if (i2 == 0) {
                if (i17 < size - 1) {
                    constraintAnchor2 = ((WidgetsList) this.mChainList.get(i17 + 1)).mBiggest.mTop;
                    paddingBottom = 0;
                } else {
                ...
                i6 = i17;
                if (i6 < size - 1) {
                    constraintAnchor = ((WidgetsList) this.mChainList.get(i6 + 1)).mBiggest.mLeft;
                    paddingRight = 0;
                } else {
    ...
    private void measureChainWrap_new(ConstraintWidget[] constraintWidgetArr, int i, int i2, int i3, int[] iArr) {
        ...
        while (i19 < size) {
            ...
            if (i2 == 0) {
                if (i19 < size - 1) {
                    constraintAnchor2 = ((WidgetsList) this.mChainList.get(i19 + 1)).mBiggest.mTop;
                    paddingBottom = 0;
                } else {
                    constraintAnchor2 = this.mBottom;
                    paddingBottom = getPaddingBottom();
