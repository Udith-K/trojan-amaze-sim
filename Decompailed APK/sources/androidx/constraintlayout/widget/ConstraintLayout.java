...
public class ConstraintLayout extends ViewGroup {
    ...
    class Measurer implements BasicMeasure.Measurer {
        ...
        public final void measure(ConstraintWidget constraintWidget, BasicMeasure.Measure measure) {
            ...
            if (i11 != BasicMeasure.Measure.TRY_GIVEN_DIMENSIONS && i11 != BasicMeasure.Measure.USE_GIVEN_DIMENSIONS && z5 && constraintWidget.mMatchConstraintDefaultWidth == 0 && z6 && constraintWidget.mMatchConstraintDefaultHeight == 0) {
                i2 = -1;
                measuredHeight = 0;
                baseline = 0;
                iMax = 0;
    ...
    */
    ...
    protected boolean dynamicUpdateConstraints(int i, int i2) {
        ...
        while (it.hasNext()) {
            ...
            Iterator it2 = this.mLayoutWidget.getChildren().iterator();
            if (it2.hasNext()) {
                View view = (View) ((ConstraintWidget) it2.next()).getCompanionWidget();
                view.getId();
                throw null;
            }
        }
