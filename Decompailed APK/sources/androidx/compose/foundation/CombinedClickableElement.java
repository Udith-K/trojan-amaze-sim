...
final class CombinedClickableElement extends ModifierNodeElement {
    ...
    public void update(CombinedClickableNodeImpl node) {
        node.m126updatenSzSaCc(this.onClick, this.onLongClickLabel, this.onLongClick, this.onDoubleClick, this.interactionSource, this.indicationNodeFactory, this.enabled, this.onClickLabel, this.role);
    }
    ...
    public int hashCode() {
        ...
        Role role = this.role;
        int iM2000hashCodeimpl = (((iHashCode3 + (role != null ? Role.m2000hashCodeimpl(role.m2002unboximpl()) : 0)) * 31) + this.onClick.hashCode()) * 31;
        String str2 = this.onLongClickLabel;
        int iHashCode4 = (iM2000hashCodeimpl + (str2 != null ? str2.hashCode() : 0)) * 31;
