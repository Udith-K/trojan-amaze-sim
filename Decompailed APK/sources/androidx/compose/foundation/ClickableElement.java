...
final class ClickableElement extends ModifierNodeElement {
    ...
    public void update(ClickableNode node) {
        node.m119updateQzZPfjk(this.interactionSource, this.indicationNodeFactory, this.enabled, this.onClickLabel, this.role, this.onClick);
    }
    ...
    public int hashCode() {
        ...
        Role role = this.role;
        return ((iHashCode3 + (role != null ? Role.m2000hashCodeimpl(role.m2002unboximpl()) : 0)) * 31) + this.onClick.hashCode();
    }
}
