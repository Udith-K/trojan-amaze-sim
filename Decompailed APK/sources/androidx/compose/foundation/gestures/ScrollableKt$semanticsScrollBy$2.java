...
final class ScrollableKt$semanticsScrollBy$2 extends SuspendLambda implements Function2 {
    ...
    ScrollableKt$semanticsScrollBy$2(ScrollingLogic scrollingLogic, long j, Ref$FloatRef ref$FloatRef, Continuation continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            float fM235toFloatk4lQ0M = this.$this_semanticsScrollBy.m235toFloatk4lQ0M(this.$offset);
            ...
            Function2 function2 = new Function2() { // from class: androidx.compose.foundation.gestures.ScrollableKt$semanticsScrollBy$2.1
                ...
                public final void invoke(float f, float f2) {
                    ...
                    ref$FloatRef.element += scrollingLogic2.reverseIfNeeded(scrollingLogic2.m235toFloatk4lQ0M(nestedScrollScope.mo202scrollByOzD1aCk(scrollingLogic2.m236toOffsettuRUvjQ(scrollingLogic2.reverseIfNeeded(f3)), NestedScrollSource.Companion.m1643getUserInputWNlRxjI())));
                }
            };
            this.label = 1;
            if (SuspendAnimationKt.animate$default(0.0f, fM235toFloatk4lQ0M, 0.0f, null, function2, this, 12, null) == coroutine_suspended) {
