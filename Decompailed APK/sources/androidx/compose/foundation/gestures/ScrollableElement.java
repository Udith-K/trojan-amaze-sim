...
final class ScrollableElement extends ModifierNodeElement {
    ...
    public int hashCode() {
        ...
        int iHashCode2 = (((((iHashCode + (overscrollEffect != null ? overscrollEffect.hashCode() : 0)) * 31) + ChangeSize$$ExternalSyntheticBackport0.m(this.enabled)) * 31) + ChangeSize$$ExternalSyntheticBackport0.m(this.reverseDirection)) * 31;
