...
public interface PlatformTypefaces {
    ...
    Typeface mo2174createDefaultFO1MlWM(FontWeight fontWeight, int i);

    /* JADX INFO: renamed from: createNamed-RetOiIg, reason: not valid java name */
    Typeface mo2175createNamedRetOiIg(GenericFontFamily genericFontFamily, FontWeight fontWeight, int i);
}
