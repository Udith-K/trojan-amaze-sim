    ...
    boolean performAccessibilityAction(int i, Bundle bundle) {
        ...
        if (i == 16908343 && bundle != null) {
            if (this.mOrientation == 1) {
                ...
                iMin = Math.min(i2, getRowCountForAccessibility(recyclerView.mRecycler, recyclerView.mState) - 1);
            } else {
                ...
                iMin = Math.min(i3, getColumnCountForAccessibility(recyclerView2.mRecycler, recyclerView2.mState) - 1);
            }
            if (iMin >= 0) {
