...
final class GapWorker implements Runnable {
    ...
    private void flushTaskWithDeadline(Task task, long j) {
        RecyclerView.ViewHolder viewHolderPrefetchPositionWithDeadline = prefetchPositionWithDeadline(task.view, task.position, task.neededNextFrame ? Preferences.UPDATE_INTERVAL_DISABLED : j);
