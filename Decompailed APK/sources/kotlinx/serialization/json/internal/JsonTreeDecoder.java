...
class JsonTreeDecoder extends AbstractJsonTreeDecoder {
    ...
    public void endStructure(SerialDescriptor descriptor) {
        ...
        if (!this.configuration.getUseAlternativeNames()) {
            ...
            Set setJsonCachedSerialNames = JsonInternalDependenciesKt.jsonCachedSerialNames(descriptor);
            ...
            setPlus = SetsKt.plus(setJsonCachedSerialNames, (Iterable) setKeySet);
        }
