...
public class LoggerAction extends Action {
    ...
    public void begin(InterpretationContext interpretationContext, String str, Attributes attributes) {
        ...
        String strSubst2 = interpretationContext.subst(attributes.getValue(LEVEL_ATTRIBUTE));
        if (!OptionHelper.isEmpty(strSubst2)) {
            if ("INHERITED".equalsIgnoreCase(strSubst2) || "NULL".equalsIgnoreCase(strSubst2)) {
        ...
        String strSubst3 = interpretationContext.subst(attributes.getValue("additivity"));
