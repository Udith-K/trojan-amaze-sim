...
public final class Huffman {
    ...
    public final void encode(ByteString source, BufferedSink sink) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            int iAnd = Util.and(source.getByte(i2), GF2Field.MASK);
            int i3 = CODES[iAnd];
    ...
    public final int encodedLength(ByteString bytes) {
        ...
        for (int i = 0; i < size; i++) {
            j += (long) CODE_BIT_COUNTS[Util.and(bytes.getByte(i), GF2Field.MASK)];
        }
    ...
    public final void decode(BufferedSource source, long j, BufferedSink sink) {
        ...
        for (long j2 = 0; j2 < j; j2++) {
            iAnd = (iAnd << 8) | Util.and(source.readByte(), GF2Field.MASK);
            terminalBitCount += 8;
            while (terminalBitCount >= 8) {
                int i = (iAnd >>> (terminalBitCount - 8)) & GF2Field.MASK;
        ...
        while (terminalBitCount > 0) {
            int i2 = (iAnd << (8 - terminalBitCount)) & GF2Field.MASK;
