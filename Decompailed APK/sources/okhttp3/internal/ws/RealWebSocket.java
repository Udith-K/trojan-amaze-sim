...
public final class RealWebSocket implements WebSocket, WebSocketReader.FrameCallback {
    ...
    private static final List ONLY_HTTP1 = CollectionsKt.listOf(Protocol.HTTP_1_1);
    ...
    public final void connect(OkHttpClient client) {
        ...
        final okhttp3.Request requestBuild = this.originalRequest.newBuilder().header("Upgrade", "websocket").header("Connection", "Upgrade").header("Sec-WebSocket-Key", this.key).header("Sec-WebSocket-Version", "13").header("Sec-WebSocket-Extensions", "permessage-deflate").build();
            ...
            try {
                ...
                try {
                    if (objPoll != null) {
                        ...
                        webSocketWriter2.writePong((ByteString) objPoll);
